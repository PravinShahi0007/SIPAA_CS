...
{
    public partial class DesbloquearIncidencias : Form
    {

        DesbloqueaIncidencias Resupdir = new DesbloqueaIncidencias();
        DesbloqueaIncidencias oIncidencias = new DesbloqueaIncidencias();
        SonaFormaPago oSonaFormaPago = new SonaFormaPago();
        Utilerias Util = new Utilerias();
        Perfil DatPerfil = new Perfil();

        public DesbloquearIncidencias()
        {
            InitializeComponent();
        }
        ...
        private void DesbloquearIncidencias_Load(object sender, EventArgs e)
        {
            // resize 
