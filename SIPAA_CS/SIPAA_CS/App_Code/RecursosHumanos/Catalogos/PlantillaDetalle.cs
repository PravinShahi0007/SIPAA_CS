...
namespace SIPAA_CS.App_Code.RecursosHumanos.Catalogos
{
    class PlantillaDetalle
    {
                                        ...
                                        string shrregcom, int itothjor, string susuumod, string sprgumod)
        {
            ...
            if (shrenttur.Equals(string.Empty)) cmd.Parameters.Add("@p_hrenttur", SqlDbType.VarChar).Value = DBNull.Value;
            else cmd.Parameters.Add("@p_hrenttur", SqlDbType.VarChar).Value = shrenttur;            
            if (scvddiasaltur == 0) cmd.Parameters.Add("@p_cvddiasaltur", SqlDbType.Int).Value = DBNull.Value;
            else cmd.Parameters.Add("@p_cvddiasaltur", SqlDbType.Int).Value = scvddiasaltur;
            if (shrsaltur.Equals(string.Empty)) cmd.Parameters.Add("@p_hrsaltur", SqlDbType.VarChar).Value = DBNull.Value;
            else cmd.Parameters.Add("@p_hrsaltur", SqlDbType.VarChar).Value = shrsaltur;
            if (itcomida == 0) cmd.Parameters.Add("@p_tcomida", SqlDbType.Int).Value = DBNull.Value;
            else cmd.Parameters.Add("@p_tcomida", SqlDbType.Int).Value = itcomida;
            if (icvdiasalcom == 0) cmd.Parameters.Add("@p_cvdiasalcom", SqlDbType.Int).Value = DBNull.Value;
            else cmd.Parameters.Add("@p_cvdiasalcom", SqlDbType.Int).Value = icvdiasalcom;
            if (shrsalcom.Equals(string.Empty)) cmd.Parameters.Add("@p_hrsalcom", SqlDbType.VarChar).Value = DBNull.Value;
            else cmd.Parameters.Add("@p_hrsalcom", SqlDbType.VarChar).Value = shrsalcom;
            if (icvdiaregcom == 0) cmd.Parameters.Add("@p_cvdiaregcom", SqlDbType.Int).Value = DBNull.Value;
            else cmd.Parameters.Add("@p_cvdiaregcom", SqlDbType.Int).Value = icvdiaregcom;
            if (shrregcom.Equals(string.Empty)) cmd.Parameters.Add("@p_hrregcom", SqlDbType.VarChar).Value = DBNull.Value;
            else cmd.Parameters.Add("@p_hrregcom", SqlDbType.VarChar).Value = shrregcom;
